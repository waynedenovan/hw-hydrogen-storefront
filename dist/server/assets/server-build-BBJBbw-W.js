...
import { ServerRouter, Await, NavLink, useLocation, useFetcher, useAsyncValue, Link, useNavigate, createCookie, UNSAFE_withComponentProps, useRouteLoaderData, Outlet, UNSAFE_withErrorBoundaryProps, useRouteError, isRouteErrorResponse, Meta, Links, ScrollRestoration, Scripts, useLoaderData, useSearchParams, data, redirect, useRevalidator, useActionData, Form, useOutletContext } from 'react-router';
import { isbot } from 'isbot';
import { renderToPipeableStream } from 'react-dom/server';
import { createContentSecurityPolicy, CartForm, useOptimisticCart, useAnalytics, Money, Image, useCustomerPrivacy, Analytics, useNonce, getShopAnalytics, VariantSelector, getSelectedProductOptions, getSitemap, getSitemapIndex, getPaginationVariables } from '@shopify/hydrogen';
...
const resetStyles = "/assets/reset-Bm6ghf1C.css";

const appStyles = "/assets/app-CaOgcNCa.css";
...
function Footer({
  ...
  return /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(Await, { resolve: footerPromise, children: (footer) => /* @__PURE__ */ jsxs("footer", { className: "footer", children: [
    ...
    /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(FooterUtilities, { settings: null, onOpenCookiePreferences }), children: /* @__PURE__ */ jsx(Await, { resolve: storefrontSettings ?? Promise.resolve(null), children: (settings) => /* @__PURE__ */ jsx(
      FooterUtilities,
      {
        settings,
        onOpenCookiePreferences
...
function FooterUtilities({
  ...
  const imageCreditText = settings?.imageCreditText?.value || DEFAULT_IMAGE_CREDIT_TEXT;
  return /* @__PURE__ */ jsxs("div", { className: "footer-utilities flex justify-center gap-4 px-4 py-3 text-xs text-gray-400 border-t border-gray-800", children: [
    POLICY_LINKS.map((policy) => {
      ...
      return /* @__PURE__ */ jsx(NavLink, { to: policy.fallbackTo, prefetch: "intent", children: policy.label }, policy.key);
    }),
    /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setOpenModal("imageCredit"), children: "Image Credit" }),
    onOpenCookiePreferences && /* @__PURE__ */ jsx("button", { type: "button", onClick: onOpenCookiePreferences, children: "Cookie Preferences" }),
    openModal === "imageCredit" && /* @__PURE__ */ jsx(
      ContentModal,
      {
        title: "Image Credit",
...
function CookieConsentGate({
  ...
  const close = isDismissibleReopen ? onForceOpenHandled : void 0;
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: "fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4",
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            onClick: (event) => event.stopPropagation(),
            children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.75rem" }, children: "We value your privacy" }),
              /* @__PURE__ */ jsxs("div", { style: { fontSize: "0.875rem", color: "rgba(255,255,255,0.8)", marginBottom: "1rem", lineHeight: 1.5 }, children: [
                "We use cookies to run this site (essential), remember your preferences (functional), understand how the site is used (analytics), and show relevant offers (marketing). Essential cookies are always on. You can accept all, reject non-essential cookies, or choose exactly which categories to allow — see our Privacy Policy in the footer for details. You can change your choice at any time via the “Cookie Preferences” link in the footer",
                consent ? " or here in your account." : "."
              ] }),
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexWrap: "wrap", gap: "0.5rem", marginBottom: managePanelOpen ? "1rem" : 0 }, children: [
                /* @__PURE__ */ jsxs(fetcher.Form, { method: "post", action: "/cookie-consent", children: [
                  /* @__PURE__ */ jsx("input", { type: "hidden", name: "intent", value: "accept_all" }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      type: "submit",
                ...
                /* @__PURE__ */ jsxs(fetcher.Form, { method: "post", action: "/cookie-consent", children: [
                  /* @__PURE__ */ jsx("input", { type: "hidden", name: "intent", value: "reject_non_essential" }),
                  /* @__PURE__ */ jsx("button", { type: "submit", style: { ...buttonBaseStyle, background: "rgba(255,255,255,0.08)", color: "white" }, children: "Reject Non-Essential" })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
              ...
              managePanelOpen && /* @__PURE__ */ jsxs(fetcher.Form, { method: "post", action: "/cookie-consent", children: [
                /* @__PURE__ */ jsx("input", { type: "hidden", name: "intent", value: "manage_preferences" }),
                /* @__PURE__ */ jsxs("label", { style: labelStyle, children: [
                  /* @__PURE__ */ jsx("input", { type: "checkbox", checked: true, disabled: true, style: { width: "auto", margin: 0 } }),
                ...
                /* @__PURE__ */ jsxs("label", { style: { ...labelStyle, marginBottom: "1rem" }, children: [
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "checkbox",
        ...
        isDismissibleReopen && /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
...
function PageLayout({
  ...
  const isCollectionPage = /^(\/(en-nz|en-au|en-us|en-za))?\/collections/.test(location.pathname);
  useEffect(() => {
    if (isHomePage) {
...
function createCookieConsentCookie(secrets) {
...
async function parseCookieConsent(request, secrets) {
  try {
...
async function serializeCookieConsent(consent, secrets) {
  const cookie = createCookieConsentCookie(secrets);
  return cookie.serialize(consent);
}
function buildCookieConsent(method, categories) {
  return {
    essential: true,
...
async function syncCookieConsentToBackend(storefrontUiUrl, internalSecret, params) {
...
async function fetchCookieConsentFromBackend(storefrontUiUrl, internalSecret, email) {
...
async function loader$s(args) {
  ...
  const cookieConsent = await parseCookieConsent(args.request, [String(env.SESSION_SECRET || "")]);
  return {
    ...deferredData,
    ...criticalData,
    cookieConsent,
...
async function loadCriticalData({
  ...
  try {
    ...
    console.error("[root] HEADER_QUERY failed — serving fallback header:", error instanceof Error ? error.message : error);
    return {
      header: lastGoodHeader ?? STATIC_FALLBACK_HEADER
    };
  }
}
function loadDeferredData({
  ...
  const storefrontSettings = storefront.query(STOREFRONT_SETTINGS_QUERY, {
  ...
  }).then(data => data?.shop ?? null).catch(() => null);
  return {
    cart: cartPromise,
...
const root = UNSAFE_withComponentProps(function App() {
  ...
  return /* @__PURE__ */jsxs(Analytics.Provider, {
    cart: data.cart,
    shop: data.shop,
    consent: data.consent,
    children: [/* @__PURE__ */jsx(CustomerPrivacySync, {
...
function normalizeProductIdForImage(externalProductId) {
...
function getSupplierDocSrc(supplierName, value) {
...
function parseDelimitedMediaValue(value) {
  if (!value) return [];
  return value.split(";").map((entry) => entry.trim());
}
function getImagesFromMetafield(supplierName, imagesValue) {
...
function getSupplierDocSrcs(supplierName, value) {
  return parseDelimitedMediaValue(value).filter((entry) => entry !== "").map((entry) => getSupplierDocSrc(supplierName, entry)).filter((src) => src !== null);
}
...
function ProductCard({ product }) {
  ...
  const localImageSrc = explicitImageSrc ?? getProductCardImageSrc(product.supplierName?.value, product.externalProductId?.value);
  useEffect(() => {
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            product.type?.value && /* @__PURE__ */ jsxs("p", { className: "text-gray-400 mt-0.5", children: [
              "Type: ",
              product.type.value
            ] }),
  ...
  return /* @__PURE__ */ jsx(
    Link,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "collection-item-media", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "collection-item-title-wrap", children: /* @__PURE__ */ jsx(Heading, { className: "collection-item-title", children: collection.displayName?.value || collection.title }) })
      ] })
    },
    collection.id
  );
...
async function fetchAllCollections(storefront, query, variables = {}) {
  const allNodes = [];
  let cursor = null;
...
async function loader$r(args) {
  ...
  const allNodes = await fetchAllCollections(storefront, CHILD_COLLECTIONS_QUERY);
  const byNormTitle = new Map(allNodes.map(c => [c.title.trim().toLowerCase(), c]));
  const {
    subCollections,
    childHeadingLevel
  } = computeChildTier(collection, allNodes);
...
function childrenOf(allNodes, normTitle) {
  return allNodes.filter(c => (c.parent?.value || "").trim().toLowerCase() === normTitle).sort((a, b) => getDisplayName(a).localeCompare(getDisplayName(b), void 0, {
    numeric: true
  }));
}
function computeChildTier(collection, allNodes) {
...
function buildBreadcrumb(collection, byNormTitle) {
  const trail = [];
...
function Breadcrumb({
  ...
  return /* @__PURE__ */jsxs("nav", {
    className: "collection-breadcrumb text-sm text-gray-300 mb-2",
    "aria-label": "Breadcrumb",
    children: [/* @__PURE__ */jsx(Link, {
      to: "/collections",
      className: "hover:text-white hover:underline",
      children: "Collections"
    }), trail.map(t => /* @__PURE__ */jsxs("span", {
      children: [" / ", /* @__PURE__ */jsx(Link, {
      ...
      children: [/* @__PURE__ */jsx("div", {
        ...
        children: /* @__PURE__ */jsxs("div", {
          children: [/* @__PURE__ */jsx(Breadcrumb, {
            ...
            children: getDisplayName(collection)
    ...
    children: [/* @__PURE__ */jsx(ScrollToTopButton, {}), /* @__PURE__ */jsxs("div", {
      ...
      children: [/* @__PURE__ */jsx("div", {
        ...
        children: [filtersOpen && /* @__PURE__ */jsxs("aside", {
          ...
          children: filteredProducts.length > 0 ? /* @__PURE__ */jsx("div", {
            ...
            children: hasFilters ? "No products match the selected filters." : "No products in this collection yet."
          })
        })]
      })]
    })]
...
async function loader$q(args) {
  ...
  const nodes = await fetchAllCollections(context.storefront, COLLECTIONS_QUERY);
...
async function loader$l(args) {
  ...
  const explicitImages = getImagesFromMetafield(product.supplierName?.value, product.images?.value);
  const candidates = explicitImages.length > 0 ? explicitImages : getProductGalleryImageSrcs(product.supplierName?.value, product.externalProductId?.value);
  const techInfoPdfCandidates = getSupplierDocSrcs(product.supplierName?.value, product.techInfoPdf?.value);
  const userManualPdfCandidates = getSupplierDocSrcs(product.supplierName?.value, product.userManualPdf?.value);
  const isLocalMediaSrc = src => !/^https?:\/\//i.test(src);
  let gallerySrcs = [];
  ...
  if (candidates.length > 0 || localTechInfoPdfCandidates.length > 0 || localUserManualPdfCandidates.length > 0) {
    ...
    const keepExisting = async srcs => (await Promise.all(srcs.map(async src => (await existsOnDisk(src)) ? src : null))).filter(src => src !== null);
    ...
    if (localUserManualPdfCandidates.length > 0) {
      userManualPdfSrcs = [...userManualPdfSrcs, ...(await keepExisting(localUserManualPdfCandidates))];
    }
  }
  return {
    product,
    ...
    children: /* @__PURE__ */jsx("div", {
      ...
      children: /* @__PURE__ */jsxs("div", {
        ...
        children: [/* @__PURE__ */jsxs("div", {
          ...
          children: [/* @__PURE__ */jsx("h1", {
          ...
          }), (partNo || product.type?.value || combinedDetailBlocks.length > 0) && /* @__PURE__ */jsxs("div", {
            ...
            }), product.type?.value && /* @__PURE__ */jsxs("p", {
              children: [/* @__PURE__ */jsxs("span", {
                className: "font-semibold text-white",
                children: ["Type:", " "]
              }), product.type.value]
          ...
          }), techInfoPdfSrcs.length > 0 && /* @__PURE__ */jsxs("div", {
            className: "mt-6 text-gray-200",
            children: [/* @__PURE__ */jsx("h3", {
              className: "mb-2 text-white",
              children: "Technical Information"
            }), techInfoPdfSrcs.map((src, index) => /* @__PURE__ */jsxs("a", {
              href: src,
              target: "_blank",
              ...
              children: ["View technical information", techInfoPdfSrcs.length > 1 ? ` ${index + 1}` : "", " (PDF)"]
            }, src))]
          }), userManualPdfSrcs.length > 0 && /* @__PURE__ */jsxs("div", {
            className: "mt-6 text-gray-200",
            children: [/* @__PURE__ */jsx("h3", {
              className: "mb-2 text-white",
              children: "User Manual"
            }), userManualPdfSrcs.map((src, index) => /* @__PURE__ */jsxs("a", {
              href: src,
              target: "_blank",
              rel: "noopener noreferrer",
              className: "block",
              ...
              children: ["View user manual", userManualPdfSrcs.length > 1 ? ` ${index + 1}` : "", " (PDF)"]
            }, src))]
...
async function loader$h({
  ...
  if (paymentGateway === "payfast") {
    const {
      getPayfastStatus,
      isPayfastDegraded
    } = await import('./payfastStatus.server-B-XKQgYi.js');
...
function ShippingMethodStep({
  ...
  function selectCollection(date, time) {
    onSelect({
      type: "collection",
      collectionDate: date,
      collectionTime: time
  ...
  const canContinue = Boolean(selected?.type === "tcg" || selected?.type === "collection" && collectionDate && collectionTime);
  if (loading) {
    return /* @__PURE__ */jsxs("div", {
      className: "checkout-form",
      children: [/* @__PURE__ */jsx("h2", {
        ...
        children: "Fetching courier rates…"
      })]
    });
  }
  return /* @__PURE__ */jsxs("div", {
    ...
    children: [/* @__PURE__ */jsx("h2", {
      ...
      className: "checkout-shipping-empty",
      children: "Couldn’t fetch courier rates right now — collection from our store is still available below."
    }), rates.length === 0 && !collectionAddress && !error && /* @__PURE__ */jsx("div", {
      className: "checkout-shipping-empty",
      ...
      children: [rates.map(rate => /* @__PURE__ */jsxs("label", {
        ...
        children: [/* @__PURE__ */jsx("input", {
          ...
          className: `checkout-shipping-option-cost ${rate.cost === 0 ? "checkout-shipping-option-free" : ""}`,
          children: rate.cost === 0 ? "Free" : /* @__PURE__ */jsx(Money, {
            data: {
              amount: String(rate.cost),
              currencyCode: "ZAR"
            }
          })
        })]
      }, rate.rateId)), collectionAddress && /* @__PURE__ */jsxs("label", {
        className: "checkout-shipping-option",
        children: [/* @__PURE__ */jsx("input", {
          type: "radio",
          name: "delivery",
          ...
          className: "checkout-shipping-option-label",
          children: ["Collection from Hose World store", /* @__PURE__ */jsxs("div", {
            style: {
              fontSize: "0.8rem",
              opacity: 0.7,
              marginTop: "2px"
            },
            children: [collectionAddress.company, ", ", collectionAddress.street, ", ", collectionAddress.city, ",", " ", collectionAddress.zone, " ", collectionAddress.code]
          })]
        }), /* @__PURE__ */jsx("span", {
          className: "checkout-shipping-option-cost checkout-shipping-option-free",
          children: "Free"
        })]
      })]
    }), isCollectionSelected && /* @__PURE__ */jsxs("div", {
      className: "checkout-form-row",
      style: {
        marginTop: "0.75rem"
      },
...
function OrderReviewStep({
  ...
  const shippingCurrency = cart.cost?.subtotalAmount?.currencyCode ?? "ZAR";
  const shippingTitle = selectedShippingMethod?.type === "tcg" ? selectedShippingMethod.title : selectedShippingMethod?.type === "collection" ? "Collection from Hose World store" : null;
  ...
  return /* @__PURE__ */jsxs("div", {
    ...
    children: [/* @__PURE__ */jsx("h2", {
    ...
    }), shippingTitle && /* @__PURE__ */jsxs("div", {
      className: "checkout-review-section",
      children: [/* @__PURE__ */jsx("h3", {
        children: "Shipping Method"
      }), /* @__PURE__ */jsxs("p", {
        children: [shippingTitle, " — ", shippingCost === 0 ? "Free" : /* @__PURE__ */jsx(Money, {
          data: {
            amount: String(shippingCost),
            currencyCode: shippingCurrency
          }
        })]
      }), selectedShippingMethod?.type === "collection" && /* @__PURE__ */jsxs("p", {
        style: {
          fontSize: "0.85rem",
          opacity: 0.75
        },
        children: ["Preferred: ", selectedShippingMethod.collectionDate, " ", selectedShippingMethod.collectionTime]
      })]
    }), /* @__PURE__ */jsxs("div", {
      className: "checkout-review-section",
      children: [/* @__PURE__ */jsx("h3", {
      ...
      }), shippingTitle && shippingCost > 0 && /* @__PURE__ */jsxs("div", {
        className: "checkout-review-total-row",
        children: [/* @__PURE__ */jsx("span", {
          children: "Shipping"
        }), /* @__PURE__ */jsx("span", {
    ...
    }), paymentGateway === "payfast" && payfastStatus && /* @__PURE__ */jsx("div", {
      className: `checkout-payfast-status-banner ${payfastStatus.indicator === "minor" ? "is-minor" : "is-outage"}`,
      children: payfastStatus.indicator === "minor" ? `PayFast is currently reporting degraded service${payfastStatus.description ? ` (“${payfastStatus.description}”)` : ""}. Your payment may be slower than usual.` : `PayFast is currently reporting an outage${payfastStatus.description ? ` (“${payfastStatus.description}”)` : ""}. Payment is temporarily unavailable — your cart is saved, please try again shortly.`
    }), /* @__PURE__ */jsxs("div", {
      className: "checkout-nav-buttons",
      children: [/* @__PURE__ */jsx("button", {
        type: "button",
...
function PayFastPaymentForm({
  ...
  return /* @__PURE__ */jsxs(payFetcher.Form, {
    ...
    children: [/* @__PURE__ */jsx("input", {
      ...
      type: "hidden",
      name: "shippingTitle",
      value: selectedShippingMethod?.type === "tcg" ? selectedShippingMethod.title : selectedShippingMethod?.type === "collection" ? "Collection from Hose World store" : ""
    }), /* @__PURE__ */jsx("input", {
      type: "hidden",
      name: "shippingCost",
      ...
      type: "hidden",
      name: "collectionDate",
      value: selectedShippingMethod?.type === "collection" ? `${selectedShippingMethod.collectionDate} ${selectedShippingMethod.collectionTime}`.trim() : ""
...
async function action$a({
  ...
  if (isPayfastOutage(payfastStatus)) {
    ...
    return data({
      error: "The payment provider (PayFast) is currently reporting an outage" + (payfastStatus.description ? ` ("${payfastStatus.description}")` : "") + ". Your cart has been saved — please try again shortly."
    }, {
      status: 503
    });
  }
  ...
  const orderPayload = {
    ...
    shippingMethod: {
      type: formData.get("shippingMethodType") || "",
      tcgRateId: formData.get("tcgRateId") || "",
      tcgServiceLevel: formData.get("tcgServiceLevel") || "",
...
async function loader$b(args) {
  ...
  const nodes = await fetchAllCollections(storefront, HOMEPAGE_COLLECTIONS_QUERY);
  const mains = nodes.filter(col => col.role?.value === "main");
...
async function loader$a({
  ...
  const engine = await import('./searchIndex.server-YLHY3i7v.js');
  if (isPredictive) {
    if (!term) {
      return {
        type: "predictive",
    ...
    const results2 = await engine.searchCatalog(context.storefront, term);
    return engine.toPredictiveResult(term, results2, limit);
  }
  if (!term) {
    return {
      type: "regular",
...
function toCardCollection(collectionResult) {
  return {
    ...
    image: collectionResult.image ? {
      ...
      width: collectionResult.image.width ?? void 0,
      height: collectionResult.image.height ?? void 0
    } : null,
...
function toCardProduct(productResult) {
  return {
    ...productResult,
    productType: productResult.productType ?? void 0,
    featuredImage: productResult.featuredImage ? {
      url: productResult.featuredImage.url,
      altText: productResult.featuredImage.altText,
      width: productResult.featuredImage.width ?? void 0,
      height: productResult.featuredImage.height ?? void 0
    } : null
  };
}
const _$locale__search = UNSAFE_withComponentProps(function Search() {
  ...
  return /* @__PURE__ */jsxs("div", {
    className: "page-card page-card--wide search",
    children: [/* @__PURE__ */jsx("h1", {
      children: "Search"
    ...
    }), term && !result.total ? /* @__PURE__ */jsxs("p", {
      className: "text-gray-300",
      children: ["No results found for ", /* @__PURE__ */jsx("q", {
        children: term
      })]
    }) : null, mainCollections.length ? /* @__PURE__ */jsxs("section", {
      className: "search-section",
      children: [/* @__PURE__ */jsx("h2", {
        children: "Collections"
      }), /* @__PURE__ */jsx("div", {
        className: "collections-grid",
        children: mainCollections.map(c => /* @__PURE__ */jsx(CollectionCard, {
          collection: toCardCollection(c),
          headingLevel: "h2"
        }, c.id))
      })]
    }) : null, subCollections.length ? /* @__PURE__ */jsxs("section", {
      className: "search-section",
      children: [/* @__PURE__ */jsx("h2", {
        children: "Sub Collections"
      }), /* @__PURE__ */jsx("div", {
        className: "collections-grid",
        children: subCollections.map(c => /* @__PURE__ */jsx(CollectionCard, {
          collection: toCardCollection(c),
          headingLevel: "h3"
        }, c.id))
      })]
    }) : null, brands.length ? /* @__PURE__ */jsxs("section", {
      className: "search-section",
      children: [/* @__PURE__ */jsx("h2", {
        children: "Brands"
      }), /* @__PURE__ */jsx("div", {
        className: "search-brand-list",
        children: brands.map(brand => /* @__PURE__ */jsxs(Link, {
          className: "search-brand-chip",
          to: `/search?q=${encodeURIComponent(brand.name)}`,
          children: [brand.name, /* @__PURE__ */jsx("span", {
            className: "search-brand-count",
            children: brand.productCount
          })]
        }, brand.name))
      })]
    }) : null, products.length ? /* @__PURE__ */jsxs("section", {
      className: "search-section",
      children: [/* @__PURE__ */jsx("h2", {
        children: "Products"
      }), /* @__PURE__ */jsx("div", {
...
const CUSTOMER_ID_QUERY$3 = `#graphql
...
async function action$8({
  ...
  const env = context.env;
  const formData = await request.formData();
  const intent = formData.get("intent") || "reject_non_essential";
  ...
  try {
    ...
    if (loggedIn) {
      ...
      const {
        data: idData
      } = await context.customerAccount.query(CUSTOMER_ID_QUERY$3);
...
function AccountNav() {
  ...
  return /* @__PURE__ */jsxs("nav", {
    ...
    children: [/* @__PURE__ */jsx("a", {
      ...
      href: "/account/cookie-preferences",
      style: linkStyle,
...
const CUSTOMER_EMAIL_QUERY$1 = `#graphql
...
async function loader$4({
  ...
  try {
    const {
      data: data2
    } = await context.customerAccount.query(CUSTOMER_EMAIL_QUERY$1);
    const email = data2?.customer?.emailAddress?.emailAddress ?? "";
    const fromBackend = email ? await fetchCookieConsentFromBackend(storefrontUiUrl, internalSecret, email) : null;
    if (fromBackend) {
      categories = fromBackend;
    } else {
      const cookieConsent = await parseCookieConsent(request, [String(env.SESSION_SECRET || "")]);
      if (cookieConsent) {
        categories = {
...
async function action$7({
  ...
  try {
    ...
    const shopifyCustomerId = data2?.customer?.id ?? "";
    const email = data2?.customer?.emailAddress?.emailAddress ?? "";
    if (email) {
      await syncCookieConsentToBackend(storefrontUiUrl, internalSecret, {
        shopifyCustomerId,
...
const account_cookiePreferences = UNSAFE_withComponentProps(function AccountCookiePreferences() {
  const {
    categories,
    configured
  } = useLoaderData();
  ...
  return /* @__PURE__ */jsxs("div", {
    children: [/* @__PURE__ */jsx("h2", {
      ...
      children: "Choose which non-essential cookie categories we may use. Essential cookies (required for login, cart and checkout) are always active. This also updates the choice remembered in your browser."
    }), !configured && /* @__PURE__ */jsx("p", {
      style: {
        color: "#f88"
      },
      children: "Cookie preferences service is not configured."
...
const route26 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  action: action$7,
  default: account_cookiePreferences,
  loader: loader$4
}, Symbol.toStringTag, { value: 'Module' }));
...
const assetsBuildDirectory = "dist/client";
  ...
  "routes/($locale).checkout.shipping-rates": {
  ...
  "routes/account.cookie-preferences": {
...
export { getProductCardImageSrc as a, getSupplierFolderPrefix as b, allowedActionOrigins as c, assetsBuildDirectory as d, basename as e, entry as f, getEmptyPredictiveSearchResult as g, future as h, isSpaMode as i, publicPath as j, routes as k, ssr as l, normalizeProductIdForImage as n, prerender as p, routeDiscovery as r, serverManifest as s };
