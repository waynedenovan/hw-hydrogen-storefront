...
export default function AccountManagement() {
  ...
  return (
    <div>
      <h2 style={{fontSize: '1.25rem', marginBottom: '1rem', color: '#fc8181'}}>Account Management</h2>
      ...
      <div style={{...cardStyle, border: '1px solid rgba(197, 48, 48, 0.3)'}}>
        <div style={{marginBottom: '1.25rem'}}>
          ...
          {!showDeactivate ? (
            ...
            <div style={{background: 'rgba(197,48,48,0.08)', borderRadius: '6px', padding: '1rem', border: '1px solid rgba(197,48,48,0.3)'}}>
              ...
              <button
                type="button"
                style={{...dangerBtnStyle, color: 'rgba(255,255,255,0.6)', borderColor: 'rgba(255,255,255,0.2)', background: 'transparent'}}
        ...
        <div style={{borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.25rem'}}>
          ...
          {!showDelete ? (
            <button
              type="button"
              style={{...dangerBtnStyle, borderColor: 'rgba(197,48,48,0.6)'}}
