...
type Module = typeof import("../($locale).checkout.shipping-rates.js")

type Info = GetInfo<{
  file: "routes/($locale).checkout.shipping-rates.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../($locale).checkout.shipping-rates.js");
}];
